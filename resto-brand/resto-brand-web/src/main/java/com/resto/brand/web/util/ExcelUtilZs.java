...
public class ExcelUtilZs<T> {
     ...
     * @throws Exception
     */
    public void exportExcel(String fileName, HttpServletRequest request, HttpServletResponse response, HSSFWorkbook workbook, String[][] headers , String[] columns, Collection<com.resto.brand.web.dto.RankingsDto> result, Map<String, String>map) throws Exception {
        ...
        for(int i=0;i<2;i++){
            ...
            switch (i) {
                case 0:
                    cell.setCellValue(new HSSFRichTextString(map.get("reportTitle")));
                    // 指定合并区域
                ...
                case 1:
                    if(map.get("startDate")!=null && map.get("endDate")!=null){
                        cell.setCellValue(new HSSFRichTextString("统计日期："+map.get("startDate")+"至"+map.get("endDate")));
                    }else {
                        cell.setCellValue(new HSSFRichTextString("统计日期："+map.get("date")));
                    }
