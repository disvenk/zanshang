...
var Controller = function(controlId,datatable){
    ...
    this.createCheckBtn = function(model,url,urlData){
	...
	this.createAliBtn = function(model,url,urlData){
		var button = $("<button class='btn btn-xs btn-primary'>编辑</button>");
		button.click(function(){
			if(_C.vue){
				_C.vue.aliPay(model);
	...
	this.createChargeBtn = function(model,url,urlData){
		var button = $("<button class='btn btn-xs btn-primary'>编辑</button>");
		button.click(function(){
			if(_C.vue){
				_C.vue.chargeSetting(model);
			}else{
				_C.loadForm({
					url:url,
					data:{id:model},
	...
	this.createThirdMoneyBtn = function(model,url,urlData){
		var button = $("<button class='btn btn-xs btn-primary'>编辑</button>");
		button.click(function(){
			if(_C.vue){
				_C.vue.thirdMoney(model);
			}else{
				_C.loadForm({
					url:url,
					data:{id:model},
