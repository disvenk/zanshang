                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"name="remainAccount" v-model="brandAccountSettings.remainAccount" placeholder="多个提醒额度，请用 逗号 隔开">
                                    </div>
                                </div>
                            </div>
                        </div>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control"name="remainAccount" v-model="brandAccountSettings.telephone" placeholder="多个手机号用,隔开">
									</div>
								</div>
							</div>
						</div>
...
//                                that.m.openAllOrder = result .data.openAllOrder ? true : false;
                ...
                initBrandAccountSettings : function (data) {
                    this.brandAccountSettings = {
                        ...
                        remainAccount : data.remainAccount || "100,-100",
