...
<div id="control">
        ...
        <div class="col-md-offset-3 col-md-6">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    <form class="form-horizontal" role="form" action="{{m.id?'wxServer/modify':'wxServer/create'}}" @submit.prevent="save">
                        <div class="form-body">
    ...
    <div class="table-div">
        <div class="table-operator">
            <s:hasPermission name="wxServer/add">
            ...
            columns: [
                ...
                },
                {
                    ...
                    createdCell:function(td,tdData,rowData,row){
                        var operator=[
                            <s:hasPermission name="wxServer/edit">
