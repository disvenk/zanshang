                                ...
                                <div class="col-sm-8">
                                    <div class="md-radio-inline">
                                        <div class="md-radio">
                                            ...
                                            <input type="radio" class="md-radiobtn" id="isAddRatio_yes" name="state"
                                                   value="1" v-model="m.state" v-if="m.id">
                                            <input type="radio" class="md-radiobtn" id="isAddRatio_yes" name="state"
                                                   value="1" v-if="!m.id" checked="checked">
                                        ...
                                        <div class="md-radio">
                                            <input type="radio" class="md-radiobtn" id="isAddRatio_no" name="state"
                                                   value="0" v-model="m.state" v-if="m.id">
                                            <input type="radio" class="md-radiobtn" id="isAddRatio_no" name="state"
                                                   value="0" v-if="!m.id">
    ...
    <div class="table-div">
        <div class="table-operator">
            ...
            <s:hasPermission name="tableQrcode/download">
                <button class="btn green pull-right" @click="download">下载</button>
            </s:hasPermission>
        </div>
...
<script>
    (function () {
        var brandList;
        $.post("tableQrcode/brandList", function (result) {
            ...
            var vueObj = new Vue({
                ...
                methods: {
                    getShopList: function(brandId){
                        var that = this;
                        $.post("tableQrcode/shopList",{brandId:brandId}, function (result) {
